...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    ;;       scroll-conservatively 10000 ; > 100
...
Maximize the frame by default on start-up. Set the font to size 9.
#+BEGIN_SRC emacs-lisp
  (use-package frame
    :preface
...
#+BEGIN_SRC emacs-lisp
  (use-package vhdl-mode
    :ensure nil
    :preface
    ;; Disable lsp-mode before beautify, workaround for ghdl-ls
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    (lsp-register-client
     (make-lsp-client :new-connection (lsp-stdio-connection "/opt/rust_hdl/target/release/vhdl_ls")
    ...
    ;;(setq lsp-vhdl-server-path "/opt/rust_hdl/target/release/vhdl_ls")
